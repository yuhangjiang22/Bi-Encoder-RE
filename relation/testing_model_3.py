...
class BEFRE(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.des_linear = nn.Linear(hf_config.hidden_size, hf_config.hidden_size)
    ...
    def forward(
        ...
        cls_rep = torch.cat([a[0].unsqueeze(0) for a in description_sequence_output])
        des_rep = self.des_linear(cls_rep)
